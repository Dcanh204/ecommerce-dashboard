    ...
    <div className='px-2 lg:px-7 pt-5'>
      <div className='w-full grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-7 mb-5'>
        ...
        <div className='flex justify-between items-center bg-[#fde2ff] p-5 rounded-md gap-3'>
          <div className='flex flex-col justify-start items-start text-[#5c5a5a]'>
            <h2 className='text-xl font-bold'>23.000.000đ</h2>
            <span className='text-sm font-medium'>Số tiền hiện có</span>
          </div>
        ...
        <div className='flex justify-between items-center bg-[#e9feea] p-5 rounded-md gap-3'>
          <div className='flex flex-col justify-start items-start text-[#5c5a5a]'>
            <h2 className='text-xl font-bold'>11.000.000đ</h2>
        ...
        <div className='flex justify-between items-center bg-[#ecebff] p-5 rounded-md gap-3'>
          <div className='flex flex-col justify-start items-start text-[#5c5a5a]'>
            <h2 className='text-xl font-bold'>0đ</h2>
            <span className='text-sm font-medium'>Số tiền đang chờ xử lý</span>
          </div>
      ...
      <div className='grid grid-cols-1 xl:grid-cols-2 gap-2 '>
        <div className='w-full text-[#d0d2d6] bg-[#6a5fdf] rounded-md p-5'>
          <h2 className='text-base font-medium'>Gửi yêu cầu rút tiền</h2>
          ...
          <div>
            <h2 className='text-base pb-4 font-medium'>Yêu cầu đang chờ duyệt</h2>
            <div className="w-full overflow-x-auto">
              <div className='min-w-[500px]'>
                <div className='flex items-center bg-[#a7a3de] uppercase min-w-[340px] rounded-md font-bold text-xs'>
        ...
        <div className='w-full text-[#d0d2d6] bg-[#6a5fdf] rounded-md p-5'>
          <div>
            <h2 className='text-base pb-4 font-medium'>Rút tiền thành công</h2>
            <div className="w-full overflow-x-auto">
              <div className='min-w-[500px]'>
