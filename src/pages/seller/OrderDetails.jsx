...
import { get_seller_order, messageClear, seller_order_status_update } from '../../stores/Reducers/orderReducer';
            ...
            <div className='pl-0 xl:pl-3 mt-3 lg:mt-0'>
              <div className='p-5 border border-slate-200 rounded-md shadow-md'>
                <div className='flex justify-between items-center'>
                  <h2 className='font-medium  text-xl text-[#d0d2d6]'>Đơn hàng</h2>
