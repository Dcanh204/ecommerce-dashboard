            ...
            <tbody>
              {[1, 2, 3, 4, 5].map((item, index) =>
                <tr className='border-b border-slate-700' key={index}>
                  ...
                  <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>Không hoạt động</td>
                  ...
                  <td scope='row' className='py-3 px-4 lg:px-8 font-medium whitespace-nowrap'>
                    <Link to="/admin/dashboard/sellers/2" className='inline-block p-[6px] bg-green-500 rounded-md hover:shadow-lg hover:bg-green-400/50 '><FaEye /></Link>
                  </td>
                </tr>
              )}
            </tbody>
