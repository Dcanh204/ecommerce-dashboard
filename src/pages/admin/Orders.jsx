    ...
    <div className='px-2 lg:px-7 pt-5'>
      <div className='w-full p-4 rounded-md bg-[#6a5fdf]'>
        <div className='flex justify-between items-center'>
          ...
          <input onChange={(e) => setSearchValue(e.target.value)} value={searchValue} className='w-[250px] px-3 py-2 outline-none border border-slate-700 rounded-md bg-transparent focus:border-indigo-400' type="text" name='search' placeholder='Tìm kiếm' />
        </div>
