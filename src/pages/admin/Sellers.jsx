          ...
          <table className='w-full text-xs text-left text-[#d0d2d6]'>
            <thead className='uppercase border-b border-slate-700'>
              <tr>
                ...
                <th scope='col' className='py-3 px-4'>Tên của hàng</th>
                <th scope='col' className='py-3 px-4'>Trạng thái</th>
                <th scope='col' className='py-3 px-4'>Email</th>
                <th scope='col' className='py-3 px-4'>Tỉnh / Thành phố</th>
                <th scope='col' className='py-3 px-4'>Khu vực</th>
              ...
              {loading ? (
                ...
                <tr key={index}>
                  ...
                  <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>
                    <img className='w-[50px] h-[50px]' src={item.image} alt="avatar" />
                  </td>
