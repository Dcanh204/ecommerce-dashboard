...
const Register = () => {
  ...
  return (
    <div className='min-w-screen min-h-screen bg-[#cdcae9] flex justify-center items-center'>
      <div className="w-[390px0px] text-[#ffffff] p-2">
        <div className='bg-[#6f68d1] p-4 rounded-md'>

          <h2 className="text-lg text-center mb-3 font-bold">Chào mừng đến với Easy Shop</h2>
          <p className="text-xs mb-4 text-center font-medium">Vui lòng đăng ký tài khoản để tạo cửa hàng của bạn</p>
          ...
          <form onSubmit={submitHandle}>
            ...
            <div className="flex flex-col w-full gap-1 mb-3">
              ...
              <input
                ...
                value={state.name}
                className="px-3 py-2 text-sm outline-none border border-slate-400 bg-transparent rounded-md"
                type="text"
                name="name"
            ...
            <div className="flex items-center gap-3 w-full mb-3">
              <input
                className="w-4 h-4 text-blue-500 overflow-hidden bg-gray-200 rounded border-gray-300 focus:ring-blue-500"
                type="checkbox"
                name="checkbox"
                id="checkbox"
              />
              <label htmlFor="checkbox" className='text-xs white-s'>
                Tôi đồng ý với chính sách bảo mật & điều khoản sử dụng
              </label>
            </div>
            ...
            <div className="flex justify-center items-center mb-3 gap-3">
              <p className='text-xs'>
                Đã có tài khoản?{" "}
                <Link className="font-bold text-sm" to="/login">Đăng nhập</Link>
              </p>
            </div>
            ...
            <div className=' w-full flex justify-center items-center mb-3'>
              ...
              <div className='w-[10%] flex justify-center items-center '>
                <span className='pb-1 text-sm'>Hoặc</span>
              </div>
              <div className='w-[45%] bg-slate-700 h-[1px]'></div>
            </div>
